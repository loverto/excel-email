...
import { MailConfigComponent } from 'app/entities/mail-config/mail-config.component';
...
describe('Component Tests', () => {
  describe('MailConfig Management Component', () => {
    let comp: MailConfigComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MailConfigComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mailConfigs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
