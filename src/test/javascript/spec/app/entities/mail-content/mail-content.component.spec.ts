...
import { MailContentComponent } from 'app/entities/mail-content/mail-content.component';
...
describe('Component Tests', () => {
  describe('MailContent Management Component', () => {
    let comp: MailContentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MailContentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mailContents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
