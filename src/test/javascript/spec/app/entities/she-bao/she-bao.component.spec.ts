...
import { SheBaoComponent } from 'app/entities/she-bao/she-bao.component';
import { SheBaoService } from 'app/entities/she-bao/she-bao.service';
import { SheBao } from 'app/shared/model/she-bao.model';

describe('Component Tests', () => {
  describe('SheBao Management Component', () => {
    let comp: SheBaoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SheBaoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sheBaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
