...
/**
 * REST controller for managing {@link org.ylf.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
public class UserInfoResource {
    ...
    public ResponseEntity<List<UserInfo>> getAllUserInfos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
