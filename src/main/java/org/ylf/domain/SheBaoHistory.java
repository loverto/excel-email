...
/**
 * The SheBaoHistory entity.
 * @author ylf
 */
@ApiModel(description = "The SheBaoHistory entity. @author ylf")
@Entity
@Table(name = "she_bao_history")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SheBaoHistory extends AbstractAuditingEntity implements Serializable {
    ...
    public SheBaoHistory xh(Integer xh) {
        this.xh = xh;
        return this;
    }
    ...
    public SheBaoHistory dept(String dept) {
        this.dept = dept;
        return this;
    }
    ...
    public SheBaoHistory name(String name) {
        this.name = name;
        return this;
    }
    ...
    public SheBaoHistory sbjsYanglaoShiye(String sbjsYanglaoShiye) {
    ...
    public SheBaoHistory sbjsGongShang(String sbjsGongShang) {
    ...
    public SheBaoHistory sbjsYiShangSheng(String sbjsYiShangSheng) {
    ...
    public SheBaoHistory grkkxxYaolang(String grkkxxYaolang) {
    ...
    public SheBaoHistory grkkxxShiye(String grkkxxShiye) {
    ...
    public SheBaoHistory grkkxxYiliao(String grkkxxYiliao) {
    ...
    public SheBaoHistory grkkxxTotal(String grkkxxTotal) {
    ...
    public SheBaoHistory dwbfYaolao(String dwbfYaolao) {
    ...
    public SheBaoHistory dwbfShiye(String dwbfShiye) {
    ...
    public SheBaoHistory dwbfYiliao(String dwbfYiliao) {
    ...
    public SheBaoHistory dwbfGongshang(String dwbfGongshang) {
    ...
    public SheBaoHistory dwbfShengyu(String dwbfShengyu) {
    ...
    public SheBaoHistory dwbfTotal(String dwbfTotal) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SheBaoHistory)) {
            return false;
        }
        return id != null && id.equals(((SheBaoHistory) o).id);
    }
